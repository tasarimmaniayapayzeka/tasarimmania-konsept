...
const YENI = {
  ...
  '/hizmetler/dijital-pazarlama/': 'Dijital Pazarlama Ajansı — Google ve Meta Ads | TasarımMania',
  '/hizmetler/dijital-pazarlama/google-ads/': 'Google Ads Yönetimi — Arama ve Görsel Ağ | TasarımMania',
  '/hizmetler/dijital-pazarlama/meta-ads/': 'Meta Ads Yönetimi — Facebook ve Instagram | TasarımMania',
  '/hizmetler/dijital-pazarlama/performans-pazarlamasi/': 'Performans Pazarlaması — Dönüşüm Yönetimi | TasarımMania',
  '/hizmetler/dijital-pazarlama/sosyal-medya-yonetimi/': 'Instagram Reklam Yönetimi ve İçerik Takvimi | TasarımMania',
  '/hizmetler/grafik-tasarim/': 'Grafik Tasarım Ajansı — Logo, Kurumsal Kimlik | TasarımMania',

  '/hizmetler/mobil-uygulama/': 'Mobil Uygulama Geliştirme Ajansı | TasarımMania',
  '/hizmetler/mobil-uygulama/ios-android/': 'Android iOS Uygulama Geliştirme — Native | TasarımMania',

  '/hizmetler/seo/': 'SEO Firmaları — Teknik, İçerik ve Yerel SEO | TasarımMania',
  '/hizmetler/seo/cok-dilli-seo/': 'Çok Dilli SEO ve hreflang Kurulumu | TasarımMania',
  '/hizmetler/seo/e-ticaret-seo/': 'Shopify SEO Hizmeti — Ürün ve Kategori | TasarımMania',
  '/hizmetler/seo/icerik-stratejisi/': 'SEO İçerik Stratejisi ve Kelime Planlaması | TasarımMania',
  '/hizmetler/seo/teknik-seo/': 'Teknik SEO Hizmeti — Core Web Vitals, Schema | TasarımMania',
  '/hizmetler/seo/yerel-seo/': 'Yerel SEO — Google İşletme Profili Yönetimi | TasarımMania',

  '/hizmetler/video-produksiyon/': 'Video Prodüksiyon Ajansı — Reklam Filmi | TasarımMania',
  '/hizmetler/video-produksiyon/ai-destekli-produksiyon/': 'AI Destekli Video Prodüksiyon — Kamerasız | TasarımMania',
  '/hizmetler/video-produksiyon/reklam-filmi/': 'Reklam Filmi Çekimi — Senaryodan Ekrana | TasarımMania',
  '/hizmetler/video-produksiyon/sosyal-video-reels/': 'Instagram Reels Prodüksiyonu — Dikey Video | TasarımMania',
  '/hizmetler/video-produksiyon/urun-videosu/': 'Ürün Videosu Çekimi — E-Ticaret Formatı | TasarımMania',

  '/hizmetler/web-tasarim-yazilim/': 'Web Tasarım ve Yazılım — Kurumsal, E-Ticaret | TasarımMania',
  '/hizmetler/web-tasarim-yazilim/bakim-destek/': 'WordPress Site Bakım ve Yönetim Hizmeti | TasarımMania',
  '/hizmetler/web-tasarim-yazilim/e-ticaret/': 'E-Ticaret Sitesi Kurulumu — WooCommerce | TasarımMania',
  '/hizmetler/web-tasarim-yazilim/kurumsal-web-sitesi/': 'Kurumsal Web Sitesi Fiyatları ve Süreci | TasarımMania',
  '/hizmetler/web-tasarim-yazilim/ozel-yazilim/': 'Özel Yazılım Geliştirme — Bayi Paneli, ERP | TasarımMania',
};
